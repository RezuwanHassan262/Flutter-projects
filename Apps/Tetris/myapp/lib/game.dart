...
class MyGame  extends StatefulWidget {
  ...
  @override
  _MyGame State createState() => _MyGame State();
}

class _MyGame State extends State<MyGame > {
  static List<List<int>> pieces = [ [4, 5, 14, 15],[4, 14, 24, 25],[5, 15, 24, 25],[4, 14, 24, 34],[4, 14, 15, 25],[5, 15, 14, 24],[4, 5, 6, 15]];

  List<Color> pieceColors = [Colors.red,Colors.yellow,Colors.purple,Colors.green,Colors.blue,Colors.brown,Colors.pink];
  List<int> chosenPiece = []; List<int> landed = []; 
  ...
  void _clearRow(){
    ...
    for(int i = 0;i<18;i++){ //number of rows = 18
      removeRow.clear();
      count = 0;
      for(int j = 0; j <10; j++){
